    ...
    return (
      <div>
        <AppBar position="static" elevation={0} style={{backgroundColor: "#252525", width: '100%'}}>
          <Toolbar>
            <img src={Logo}
              style={{ height: "9%", width: "9%", display: "flex", alignItems: "center",
              ...
              <List component="nav" style={{marginRight: 0, marginLeft: "auto", display: 'flex', flexDirection: 'row', padding: 0, width: "50%"}}>
                ...
                <ListItem label="Home" to='/submission' component={Link} className = "link">
                  <Typography variant="subtitle1"> Submission Video </Typography>
                </ListItem>
              </List>
            </Toolbar>
        </AppBar>
